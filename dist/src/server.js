...
import { searchLibraries, fetchLibraryDocumentation, listDocumentationResources, readDocumentationResource, searchCommunity } from "./lib/localDocs.js";
function createServer() {
    const srv = new Server({
        name: "Local SAP Docs",
        description: "Offline SAPUI5 & CAP documentation server with SAP Community integration",
        version: "0.1.0"
    }, {
        capabilities: {
